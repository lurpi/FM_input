...
def out_arr( outfile,list):
 ...
 f.close()
 return;
r0="FM1_time_INJ_POINT_00.tec"
r1="FM1_time_P2.tec"
r2="FM1_time_P3.tec"
r3="FM1_time_MP_18below.tec"
...
P1 = p1["STRAIN_PLS"].values
P2 = p2["STRAIN_PLS"].values
P_f2 = p3["STRAIN_PLS"].values
...
ax2.plot(X, P_inj/1.e6, 'r--', lw=1.5,label='Injection pressure')
ax1.plot(X2, P2, 'bo', lw=2.5,label='PLS_strain at P3')
ax1.plot(X_f2, P_f2, 'g-o', lw=2.5,label='PLS_strain at 18cm below')
#ax1.plot(X, Dx1, 'ro',label='P receiver')
ax1.set_xlabel('Time (s)', fontsize=28)
#ax1.set_ylabel('Displacement ($\mu$m)', fontsize=28)
ax2.set_ylabel('Pressure (MPa)', fontsize=28)
ax1.set_ylabel('Plastic strain', fontsize=28)
